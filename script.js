...
const spotify_uri = 'REDIRECT_URI';
...
//////////////////////////
const uri_log = `https://accounts.spotify.com/authorize?client_id=`$client_id`&response_type=code&redirect_uri=http%3A%2F%2Flocalhost%3A5500&scope=user-read-private%20user-read-email%20user-read-playback-state%20user-read-currently-playing%20user-read-recently-played%20user-modify-playback-state%20app-remote-control%20user-read-email%20playlist-read-collaborative%20user-read-private%20playlist-modify-public%20user-library-modify%20user-read-playback-position%20user-read-currently-playing%20user-read-playback-state`;


document.getElementById("spo-but").onclick = function() {
    location.href = `https://accounts.spotify.com/authorize?client_id=`$client_id`&response_type=token&redirect_uri=http://localhost:5500/dsa_spotify/index.html&show_dialog=true&scope=playlist-modify-public%20user-top-read%20streaming%20user-read-email%20user-read-private%20user-read-playback-position%20user-library-read%20user-read-playback-state%20user-modify-playback-state`;
};
